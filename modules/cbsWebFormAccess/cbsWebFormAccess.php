...
class cbsWebFormAccess extends CRMEntity {
	var $db, $log; // Used in class functions of CRMEntity

	var $table_name = 'vtiger_cbswebformaccess';
	var $table_index= 'cbswebformaccessid';
	 ...
	 */
	var $customFieldTable = Array('vtiger_cbswebformaccesscf', 'cbswebformaccessid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_cbswebformaccess', 'vtiger_cbswebformaccesscf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_cbswebformaccess'   => 'cbswebformaccessid',
	    'vtiger_cbswebformaccesscf' => 'cbswebformaccessid');
	...
	var $list_fields = Array (
		...
		'Web Form Access No.'=> Array('cbswebformaccess', 'webformaccessno'),
		'Access Date'=> Array('cbswebformaccess', 'access_date'),
        'Access Time'=> Array('cbswebformaccess', 'access_time'),
        'Related to'=> Array('cbswebformaccess', 'relid'),
        'Access Web'=> Array('cbswebformaccess', 'access_web'),
        'Submit'=> Array('cbswebformaccess', 'submit')
	);
	var $list_fields_name = Array(
		/* Format: Field Label => fieldname */
		'Web Form Access No.'=> 'cbswebformaccessno',
	...
	var $list_link_field = 'cbswebformaccessno';
	...
	var $popup_fields = Array('cbswebformaccessno');

	// Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields
	var $sortby_fields = Array();

	// For Alphabetical search
	var $def_basicsearch_col = 'cbswebformaccessno';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'cbswebformaccessno';

	// Required Information for enabling Import feature
	var $required_fields = Array('cbswebformaccessno'=>1);

	// Callback function list during Importing
	var $special_functions = Array('set_import_assigned_user');

	var $default_order_by = 'cbswebformaccessno';
	var $default_sort_order='ASC';
	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	var $mandatory_fields = Array('createdtime', 'modifiedtime', 'cbswebformaccessno');
